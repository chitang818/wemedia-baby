...
class RandomCopywritingSubLibraryWidget(QWidget):
    """随机文案库 - 子分类管理页面 (表格形式)"""
    ...
    def _setup_ui(self):
        ...
        # 初始加载
        QTimer.singleShot(100, lambda: asyncio.create_task(self._reload()))
    ...
    def _on_reload_clicked(self):
        asyncio.create_task(self._reload_and_sync_summary())
    ...
    def _on_new_clicked(self):
        ...
        if dialog.exec():
            ...
            asyncio.create_task(self._save_item(data))
...
class RandomCopywritingPage(BasePage):
    ...
    def _setup_content(self):
        ...
        self.summary_widget.delete_requested.connect(
            lambda route_key: asyncio.create_task(
        ...
        # 异步加载所有历史分类
        QTimer.singleShot(100, lambda: asyncio.create_task(self._reload_categories()))
    ...
    def _on_add_new_category_requested(self):
        ...
        if dialog.exec():
            ...
            asyncio.create_task(self._add_category_to_db(name))
    ...
    def _on_category_edit_requested(self, route_key: str, old_name: str):
        ...
        if dialog.exec():
            ...
            asyncio.create_task(self._update_category_name(route_key, old_name, new_name))
