...
class TaskDetailDialog(QDialog):
    ...
    def __init__(self, task_id: int, batch_task_manager: Any, parent=None):
        ...
        self._load_details_timer = QTimer(self)
        self._load_details_timer.setSingleShot(True)
        self._load_details_timer.timeout.connect(self._load_details_async)
        self._load_details_timer.start(0)
