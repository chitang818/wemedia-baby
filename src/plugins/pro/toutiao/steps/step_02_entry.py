...
"""
步骤2：进入发布页
文件路径: src/plugins/pro/toutiao/steps/step_02_entry.py

流程：
  1. 优先尝试直接导航到发布页 URL（/profile_v4/xigua/upload）
...
PUBLISH_URL = "https://mp.toutiao.com/profile_v4/xigua/upload"
