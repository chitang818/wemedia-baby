...
"""
步骤7：点击发布
文件路径: src/plugins/pro/duoduoshipin/steps/step_07_submit.py
...
class SubmitStep(BasePublishStep):
    ...
    async def _verify_publish_result(self, page: Page, metadata: Dict[str, Any]) -> PublishResult:
        ...
        try:
            ...
            current_url = page.url
            if "short-video" not in current_url and "live.pinduoduo.com" in current_url:
