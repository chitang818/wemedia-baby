...
"""
步骤4：作品描述（标题、简介、标签）
文件路径: src/plugins/pro/bilibili/steps/step_04_description.py

流程：
  1. 标题填写：定位标题输入框（TITLE_INPUT），清空后逐字输入（B站标题限 80 字）
  2. 简介填写：
